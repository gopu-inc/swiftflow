...
static const Keyword keywords[] = {
    ...
    {"from", TK_IDENT},  // "from" n'est pas un mot-clé spécial, juste un identifiant
    // End marker
    {NULL, TK_ERROR}
};

// ======================================================
// [SECTION] AST NODE DEFINITIONS - MODIFIÉE
// ======================================================
typedef enum {
    // Expressions
    NODE_INT,
...
typedef struct ASTNode {
    ...
    int import_count;
    char* from_module;  // NOUVEAU: pour "import() {..., from "module"}"
} ASTNode;
